...
module.exports = {
    name: 'cry',
    description: 'Express your sadness with tears.',
    usage: 'cry [message]',
    cooldown: 3000,
    async execute(message, args) {
        ...
        try {
            ...
            try {
                const res1 = await fetch('https://nekos.best/api/v2/cry');
                const data1 = await res1.json();
                console.log('Nekos.best cry response:', data1);
                ...
                console.log('Nekos.best cry API failed:', e);
            }
            ...
            if (gifUrl) {
                console.log('Using cry GIF URL:', gifUrl);
                embed.setImage(gifUrl);
            } else {
                console.log('No cry GIF found from any API');
            }
